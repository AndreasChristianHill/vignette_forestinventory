...
%
% - mention that the support size does not have to match the plotsize of the terrestrial inventory. In fact, it will in practice be chosen in order to
%
% - mention that a change of support size between sample points for a given expl. variable is not allowed (because.... Daniel ?)
%
%
