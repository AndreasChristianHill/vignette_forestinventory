...
\title{The \proglang{R} Package \pkg{forestinventory}: Design-Based Global and Small Area Estimations for Multi-Phase Forest Inventories}
...
% NOTES:
% - mention difference between finite and infinite population approach ?
%
%
%
